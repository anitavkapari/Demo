...
export default function UpdatePaymentDetails(props) {
        ...
        <KeyboardAvoidingView
          ...
          contentContainerStyle={{
            ...
            <MaskInput
              ...
              placeholder="4512 5556 6684 5854"
          ...
          onPress={()=>{
            ...
            <Text
              style={{
                ...
                fontSize: normalize(12),
                fontFamily: 'Roboto-Medium',
                marginLeft:normalize(Platform.OS === 'ios' ? 5 : 10)
              }}>
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.txt, {color: Colors.white}]}>Update</Text>
          </TouchableOpacity>
        </View>
        </View>
          </ScrollView>
        ...
        <View style={styles.sndTxtContainer}>
          <Modal isVisible={isModalVisible}>
            <View style={styles.modal}>
              ...
              <Text style={styles.verification}> Update Successful !</Text>
